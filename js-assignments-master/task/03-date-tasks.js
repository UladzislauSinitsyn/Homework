...
function timeSpanToString(startDate, endDate) {
  return parseInt((endDate-startDate)/(3600*1000))+':'+parseInt((endDate-startDate)/(60*1000)%60)+':'+parseInt((endDate-startDate)/(1000)%60)+'.'+parseInt((endDate-startDate)%10000);
}
...
function angleBetweenClockHands(date) {
  return ((30 * (date.getHours() % 12) + date.getMinutes() * 0.5) - 6 * date.getMinutes());
}
