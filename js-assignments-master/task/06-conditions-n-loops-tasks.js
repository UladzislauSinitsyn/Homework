...
function getFizzBuzz(num) {
  let r = "";
  if(n%3!=0 && n%5!=0) return r=n;
  if(n%3==0) r="Fizz";
  if(n%5==0) return r+="Buzz";
}
...
function doRectanglesOverlap(rect1, rect2) {
  return rect2.top>rect1.top+rect1.height||rect2.left>rect1.left+rect1.width||rect1.top>rect2.top+rect2.height||rect1.left>rect2.left+rect2.width ? false : true;
}
...
function getIntervalString(a, b, isStartIncluded, isEndIncluded) {
  let str = "";
  isStartIncluded == true ? str += "[" + a : str += "(" + a;
  isEndIncluded == true ? str += "," +b + "]" : str += "," + b + ")";
  return str;
}
...
function timespanToHumanString(startDate, endDate) {
  let diff = endDate - startDate; 
    ...
    if (diff <= 90 * 1000)
      return "a minute ago ago" 
    if (diff <= 45 * 60 * 1000)
      return "a " + Math.round(diff / 60 / 1000) + " minutes ago ago" 
    if (diff <= 90 * 60 * 1000)
      return "an hour ago" 
    if (diff <= 22 * 60 * 60 * 1000)
      return "a " + Math.round(diff / 60 / 60 / 1000) + " hours ago" 
    if (diff <= 36 * 60 * 60 * 1000)
      return "a day ago" 
    if (diff <= 25 * 24 * 60 * 60 * 1000)
      return "a " + Math.round(diff / 24 / 60 / 60 / 1000) + " days ago" 
    if (diff <= 45 * 24 * 60 * 60 * 1000)
      return "a month ago" 
    if (diff <= 345 * 24 * 60 * 60 * 1000)
      return "a " + Math.round(diff / 30 / 24 / 60 / 60 / 1000) + " months ago" 
    if (diff <= 545 * 24 * 60 * 60 * 1000)
      return "a year ago"
      if (diff > 545 * 24 * 60 * 60 * 1000)
      return "a " + (Math.round(diff / 346 / 24 / 60 / 60 / 1000) - 1) + " years ago"
}
...
function getCommonDirectoryPath(pathes) {
  let path = pathes[0].substr(0, pathes[0].lastIndexOf("/") + 1);
   for(let i = 1; i < pathes.length; i++)
   {
     if(path!=pathes[i].substr(0, pathes[0].lastIndexOf("/") + 1)) return "/";
   }
   return path;
}
